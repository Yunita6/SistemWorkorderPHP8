...
header("Content-Disposition: attachment; filename=Laporan Operator.xls");
?>
<!-- halaman HTML yang akan diexport ke excel -->
<!-- judul tabel -->
<center>
  <h2>Laporan Operator</h2>
</center>
...
// Query hanya untuk data dengan status 'Completed'
...
<h2>Rekapitulasi Workorder - Status Completed</h2>
<table border='1'>
        <tr style="background-color:#31316a;color:#fff">
            <th>Nama Produk</th>
            <th>Status</th>
